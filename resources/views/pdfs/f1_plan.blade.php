...
<head>
    ...
    <style>
        ...
        table.info { width: 100%; border-collapse: collapse; margin-top: 15px; margin-bottom: 20px; border: 1px solid #000; }
        table.info th { background-color: #eee; text-align: left; padding: 6px; border: 1px solid #000; }
        table.info td { padding: 5px 6px; vertical-align: top; border: 1px solid #000; }
        table.info td.label { font-weight: bold; width: 150px; }
    ...
    <div class="container">
        ...
        <table class="info" style="border: none; margin-top: 30px;">
            ...
            <tr style="border: none;">
                ...
                <td style="border: none;">: {{ $practica->advisor->name }}</td>
            </tr>
            </table>
